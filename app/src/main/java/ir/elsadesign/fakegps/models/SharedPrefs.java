...
public final class SharedPrefs {
    ...
    // --------------------------------------------------------------------------------------------- putDynamicPointOriginLat()

    public static boolean putDynamicPointOriginLat(Context context, double value) {
        SharedPreferences.Editor editor = getSharedPreferencesEditor(context);
        return putDynamicPointOriginLat(editor, context, value, true);
    }

    public static boolean putDynamicPointOriginLat(SharedPreferences.Editor editor, Context context, double value, boolean flush) {
        int pref_key_id = R.string.pref_dynamic_origin_lat;
        return putDouble(editor, context, pref_key_id, value, flush);
    }

    // --------------------------------------------------------------------------------------------- getDynamicPointOriginLat()

    public static double getDynamicPointOriginLat(Context context) {
        SharedPreferences sharedPreferences = getSharedPreferences(context);
        return getDynamicPointOriginLat(sharedPreferences, context);
    }

    public static double getDynamicPointOriginLat(SharedPreferences sharedPreferences, Context context) {
        int pref_key_id = R.string.pref_dynamic_origin_lat;
        double defValue = 38.897957;  // The White House, Washington, DC, USA
        return getDouble(sharedPreferences, context, pref_key_id, defValue);
    }

    // --------------------------------------------------------------------------------------------- putDynamicPointOriginLon()

    public static boolean putDynamicPointOriginLon(Context context, double value) {
        SharedPreferences.Editor editor = getSharedPreferencesEditor(context);
        return putDynamicPointOriginLon(editor, context, value, true);
    }

    public static boolean putDynamicPointOriginLon(SharedPreferences.Editor editor, Context context, double value, boolean flush) {
        int pref_key_id = R.string.pref_dynamic_origin_lon;
        return putDouble(editor, context, pref_key_id, value, flush);
    }

    // --------------------------------------------------------------------------------------------- getDynamicPointOriginLon()

    public static double getDynamicPointOriginLon(Context context) {
        SharedPreferences sharedPreferences = getSharedPreferences(context);
        return getDynamicPointOriginLon(sharedPreferences, context);
    }

    public static double getDynamicPointOriginLon(SharedPreferences sharedPreferences, Context context) {
        int pref_key_id = R.string.pref_dynamic_origin_lon;
        double defValue = -77.036560;  // The White House, Washington, DC, USA
        return getDouble(sharedPreferences, context, pref_key_id, defValue);
    }
    ...
    // --------------------------------------------------------------------------------------------- putDynamicPointOrigin()
    public static boolean putDynamicPointOrigin(Context context, LocPoint point, boolean flush) {
        SharedPreferences.Editor editor = getSharedPreferencesEditor(context);
        double lat = point.getLatitude();
        double lon = point.getLongitude();

        putDynamicPointOriginLat(editor, context, lat, false);
        putDynamicPointOriginLon(editor, context, lon, false);

        return flush && editor.commit();
    }

    // --------------------------------------------------------------------------------------------- getDynamicPointOrigin()

    public static LocPoint getDynamicPointOrigin(Context context) {
        SharedPreferences sharedPreferences = getSharedPreferences(context);
        return getTripOrigin(sharedPreferences, context);
    }

    public static LocPoint getDynamicPointOrigin(SharedPreferences sharedPreferences, Context context) {
        double lat = getDynamicPointOriginLat(sharedPreferences, context);
        double lon = getDynamicPointOriginLon(sharedPreferences, context);
