...
import ir.elsadesign.fakegps.databinding.ActivityTripSimulationBinding
...
class TripSimulationActivity : RuntimePermissionsActivity() {
    private lateinit var originalLocOrigin: LocPoint
    private lateinit var originalLocDestination: LocPoint
    private var originalTripDuration = 0
    private lateinit var binding: ActivityTripSimulationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTripSimulationBinding.inflate(layoutInflater)
        ...
        binding.buttonToggleState.setOnClickListener {
            if (LocationService.isStarted()) {
                ...
                binding.statusText.text = getString(R.string.select_origin)
        ...
        binding.marker.setOnClickListener {
            if (originPosition == null && destinationPosition == null)
                setOrigin()
            else if (originPosition != null && destinationPosition == null)
                setDestination()
        }
    }
    ...
    private fun setOrigin() {
        ...
        binding.statusText.text = getString(R.string.select_destination)
        binding.statusLayout.setOnClickListener(null)
    }

    @SuppressLint("CheckResult")
    private fun selectDuration() {
        MaterialDialog(this)
            .title(R.string.select_destination)
            .message(R.string.trip_duration_message)
            .show {
                input(
                    waitForPositiveButton = true,
                    inputType = InputType.TYPE_CLASS_NUMBER
                ) { _, text ->
                    originalTripDuration = text.toString().toInt() * 60
    ...
    override fun onBackPressed() {
        when {
            LocationService.isStarted() -> finish()
            destinationPosition != null -> {
                destinationPosition = null
                binding.statusText.text = getString(R.string.select_destination)
            }

            destinationPosition == null && originPosition != null -> {
                originPosition = null
                binding.statusText.text = getString(R.string.select_origin)
            }

            destinationPosition == null && originPosition == null -> super.onBackPressed()
        }
    }
    ...
    private fun setDestination() {
        ...
        binding.statusText.text = getString(R.string.select_duration)
    ...
    override fun onPermissionsGranted() {
        Log.d("Location Result", "permission granted")
    }
